...
import ru.practicum.shareit.request.exception.ItemRequestExistsException;
...
public class ItemRequestRepositoryImpl implements ItemRequestRepository {
    ...
    private void checkOnExist(ItemRequest request) {
         if (itemRequests.stream()
             ...
             throw new ItemRequestExistsException("Item request with id: " + request.getId() + " already exists");
         }
    }
